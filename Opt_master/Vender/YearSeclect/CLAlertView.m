...
- (void)setTitleArray:(NSArray *)titleArray{
    ...
    if (titleArray.count * 51 >= (ScreenHeight *2/3- 52)) {
        self.backView.frame = CGRectMake(0, ScreenHeight *1/3 - 55, ScreenWidth, ScreenHeight);
        
        self.tableView.frame = CGRectMake(0, ScreenHeight *1/3, ScreenWidth, ScreenHeight *2/3- 55);
        self.titleLabel.center = CGPointMake(ScreenWidth/2, ScreenHeight *1/3 - 24);
    ...
    self.disSelectButton.frame = CGRectMake(0, ScreenHeight - 55, ScreenWidth, 51);
