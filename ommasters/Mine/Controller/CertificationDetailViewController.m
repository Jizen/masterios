...
//        NSURLSessionDataTask *dataTask = [[HttpTool shareManager] dataTaskWithRequest:<#(NSURLRequest *)#> completionHandler:<#^(NSURLResponse *response, id responseObject, NSError *error)completionHandler#>];
